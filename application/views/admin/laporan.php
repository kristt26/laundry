        ...
        <div class="col-sm-5 d-flex justify-content-between">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                    ...
                    <button class="btn btn-primary caridata" data-Url="<?= base_url()?>admin/laporan/getprint"><i class="fa fa-search"></i></button>
                  </div>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="d-flex justify-content-start">
              ...
              <button class="btn btn-primary">PDF</i></button>
            </div>
          </div>
        </div>
  ...
  $(function () {
    $(document).ready(function () {
      ...
      $('.caridata').on('click', function () {
        ...
        var a = tgl.split(' - ');
        var dataa = {'tglawal':a[0], 'tglakhir':a[1]};
        $.ajax({
                type: 'POST',
                url: Url,
                data:dataa,
                success: function (data) {
                  ...
                  $.each($data, function( index, value ) {
                    var html="<tr><td>"+Number(1+index)+"</td><td>"+value.kd_pemesanan+"</td><td>"+value.tgl_ambil+"</td><td>"+value.jenis_type+"</td><td>"+value.berat+"</td><td>"+value.jumlah+"</td></tr>";
